...
**FlixsterPt2** is a movie browsing app that allows users to browse top rated movies and view their reviews. 
...
Some issues setting up dependencies.
One field, rating, can't be returned successfully from serialization.
